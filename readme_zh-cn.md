...
![RPG 仪表盘](docs/dashboard-v2.png)

### 功能特性

- **XP 与等级系统** — 通过洞察 (20)、任务 (30) 和记忆 (15) 获取经验值。从 1 级升到 10 级。
- **技能树** — 8 个技能，随着 Agent 维度提升逐步解锁（洞察之眼、永恒记忆、自省大师……）
- **成就系统** — 8 个成就，从"初出茅庐"到"进化大师"
- **质量趋势** — 近期任务表现的可视化柱状图
- **JSON API** — `evolve report --json` 输出 JSON 格式，方便与其他工具集成
